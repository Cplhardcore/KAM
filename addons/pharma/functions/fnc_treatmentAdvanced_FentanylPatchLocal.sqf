...
[_patient, "Fentanyl", 0, 3, 0, 0, 0, 0.6, 0, 1.02, 0.05, 0.1, -0.05, 0, 0.12, "false", "false", "true"] call EFUNC(vitals,addMedicationAdjustment);
...
[{
    params ["_patient", "_partIndex"];
        [{
            ...
            [_patient, "Fentanyl", 0, 3, 0, 0, 0, 1, 0, 1.02, 0.05, 0.1, -0.05, 0, 0.12, "false", "false", "true"] call EFUNC(vitals,addMedicationAdjustment);
        }, 3, [_patient,_partIndex]] call CBA_fnc_addPerFrameHandler;
}, [_patient, _partIndex], 3] call CBA_fnc_waitAndExecute;