...
[_patient, "Fentanyl", 0, 3, 0, 0, 0, 0.6, 0, 1.02, 0.05, 0.1, -0.05, 0, 0.12, 0, 0, 1] call EFUNC(vitals,addMedicationAdjustment);
...
[{
    params ["_patient", "_partIndex"];
        [{
            ...
            [_patient, "Fentanyl", 0, 3, 0, 0, 0, 1, 0, 1.02, 0.05, 0.1, -0.05, 0, 0.12, 0, 0, 1] call EFUNC(vitals,addMedicationAdjustment);
