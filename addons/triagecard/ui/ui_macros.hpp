...
#define KAT_TCpxToScreen_X(X) (X / 1024 * KAT_GUI_GRID_W + KAT_GUI_GRID_X)
#define KAT_TCpxToScreen_Y(X) (X / 1024 * KAT_GUI_GRID_H + KAT_GUI_GRID_Y)
#define KAT_TCpxToScreen_W(X) (X / 1024 * KAT_GUI_GRID_W)
#define KAT_TCpxToScreen_H(X) (X / 1024 * KAT_GUI_GRID_H)