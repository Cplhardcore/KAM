...
TRACE_7("brain_CPR",_newCVR,_CVR,_targetCVR,_targetCVR_raw,_fatigueMultiplier,_targetCBF,_paCO2Factor);
...
private _dO2 = _unit getVariable [QEGVAR(vitals,oxygenDelivery),10];
private _oxygenFactor = linearConversion [3,9,_dO2,0.25,1,true];
_CPR = _CPR * _oxygenFactor;
TRACE_7("brain_CPR",_oxygenFactor,_dO2,_CPR,(GET_KAT_SPO2(_unit)/98),(_CPP / _newCVR),_CPP,_newCVR);
