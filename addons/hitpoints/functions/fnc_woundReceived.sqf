...
private _typeOfDamage = _ammo call ACEFUNC(medical_damage,getTypeOfDamage);

if !(_typeOfDamage in ACEGVAR(medical_damage,damageTypeDetails)) exitWith {};

(ACEGVAR(medical_damage,damageTypeDetails) get _typeOfDamage) params ["", "", "_woundHandlers"];
