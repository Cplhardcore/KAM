...
private _oxygenDelivery = _patient getVariable [QEGVAR(vitals,oxygenDelivery), 10];
...
private _cardiacOutput = ((_patient call EFUNC(vitals,getCardiacOutput)) * (_oxygenDelivery/10));
